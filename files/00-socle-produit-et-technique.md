...
| | **A. Prestataire (sous-traitance)** | **B. Mandataire / mise en relation** *(recommandé)* |
|---|---|---|
...
:root {
  /* Tons papier */
  --paper-000:#FFFFFF; --paper-050:#FAF8F4; --paper-100:#F2EFE7;
  --paper-200:#E6E1D6; --paper-300:#D3CDBF;

  /* Encre */
  --ink-900:#14150F; --ink-700:#3A3B33; --ink-500:#6B6C61; --ink-400:#8E8F84;
  ...
  /* Sémantique */
  --ok-600:#0F7A4A;  --warn-600:#B4740A; --risk-600:#C0392B; --info-600:#2C5AA0;
  --ok-050:#E8F5EE;  --warn-050:#FDF3E1; --risk-050:#FBEAE7; --info-050:#EAF0FA;
...
[data-theme='consumer'] { --radius-card:12px; --radius-btn:10px; --radius-pill:999px; }
[data-theme='ops']      { --radius-card:0;    --radius-btn:0;    --radius-pill:0; }
```
