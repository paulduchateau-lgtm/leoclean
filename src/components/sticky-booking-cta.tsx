      ...
      >
        <div className="mx-auto flex max-w-lg items-center justify-between gap-3 px-4 py-2.5">
          ...
          <Link
            ...
            className="inline-flex h-12 shrink-0 items-center rounded-full bg-primary px-6 font-bold whitespace-nowrap text-primary-foreground shadow-xs transition-colors duration-200 ease-brand hover:bg-pineapple-500"
          >
            Réserver
          </Link>
        </div>
