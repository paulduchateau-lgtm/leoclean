...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-lg leading-snug font-extrabold tracking-[-0.01em] group-data-[size=sm]/card:text-base",
        className,
      )}
      {...props}
    />
